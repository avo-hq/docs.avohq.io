...
Override per resource by adding `.limit()` in the `query:` proc — your limit always wins:
...
This applies to resource-index search, global search, and [searchable association pickers](./../associations/searchable).
