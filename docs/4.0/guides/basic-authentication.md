...
<Image src="/assets/img/4_0/basic-auth/basic-auth.webm" dark-src="/assets/img/4_0/basic-auth/basic-auth-dark.webm" width="1000" height="655" alt="Add Avo behind Basic Authentication" />
