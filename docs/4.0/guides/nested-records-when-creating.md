...
<Image src="/assets/img/4_0/guides/nested-records-when-creating/nested-records-demo.gif" dark-src="/assets/img/4_0/guides/nested-records-when-creating/nested-records-demo-dark.gif" width="920" height="518" alt="Creating nested review records inline on the Fish New form by clicking Add another review" />
