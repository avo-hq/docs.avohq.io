...
<Image src="/assets/img/4_0/guides/nested-records-when-creating/nested-records-demo.webm" dark-src="/assets/img/4_0/guides/nested-records-when-creating/nested-records-demo-dark.webm" width="920" height="518" alt="Creating nested review records inline on the Fish New form by clicking Add another review" />
...
:::info
Use [this guide](./../asset-handling.html#add-your-own-css-and-javascript) to add custom JavaScript to your Avo app.
:::
