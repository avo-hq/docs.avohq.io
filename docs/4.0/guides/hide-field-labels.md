...
You can hide that label using CSS in your [custom asset pipeline](./../custom-asset-pipeline.html), or in an ejected [`_head` partial](./../eject-views#prepared-templates).
