...
- What the client may do: **Records** as *Read*, *Read & write*, or *Choose per resource*, and **Run actions** as its own toggle. Read & write includes deleting — the word is marked in the description — and ticking run actions reveals a line explaining what that grant means.
