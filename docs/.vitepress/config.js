      ...
      "/4.0/": [
        {
          ...
          items: [
            ...
            {text: "Code editors and LLM setup", link: "/4.0/llms.html"},
          ]
        },
        // {
      ...
      "/3.0/": [
        {
          ...
          items: [
            ...
            {text: "Code editors and LLM setup", link: "/3.0/llms.html"},
          ]
        },
        // {
        //   text: "Getting started",
      ...
      "/2.0/": [
        {
          ...
          items: [
            ...
            {text: "Code editors and LLM setup", link: "/2.0/llms.html"},
          ],
        },
        {
          text: "Configuration",
