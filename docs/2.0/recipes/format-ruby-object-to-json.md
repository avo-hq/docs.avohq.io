...
<img :src="('/assets/img/recipes/format-ruby-object-to-json/before.webp')" alt="Avo Admin for Rails" class="border mb-4" />
...
<img :src="('/assets/img/recipes/format-ruby-object-to-json/after.webp')" alt="Avo Admin for Rails" class="border mb-4" />
