...
<img :src="('/assets/img/stimulus/country-city-select.webm')" alt="Debug on input stimulus method" class="border mb-4" />
...
<img :src="('/assets/img/stimulus/toggle-method.webm')" alt="Toggle method" class="border mb-4" />
...
<img :src="('/assets/img/stimulus/disable-method.webm')" alt="Disable method" class="border mb-4" />
...
<img :src="('/assets/img/stimulus/debug-on-input.webm')" alt="Debug on input stimulus method" class="border mb-4" />
