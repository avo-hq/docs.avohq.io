...
const defaultOutputGenerator = new OutputGenerator(defaultFileUtils);

/**
 * Convenience functions
 */
async function findMarkdownFiles(directory, config = {}) {
  const fileUtils = new FileUtils(config);
  return await fileUtils.findMarkdownFiles(directory);
}

async function generateOutputFile(templateCollection, outputPath, config = {}) {
