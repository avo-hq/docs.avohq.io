import { logger, ConfigurationError, ErrorHandler } from './logger.js';
 ...
 */
export const defaultValidator = new VersionValidator();
export const defaultProcessor = new VersionProcessor(defaultValidator);
 ...
 * @returns {Object} Validation result
 */
export function validateVersion(version, config = {}) {
 ...
 */
export function processVersion(version, config = {}) {
  const validator = new VersionValidator(config);
